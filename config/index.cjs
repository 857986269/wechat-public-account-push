...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx9a4d0790222f8372',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '6b54023c848beb647ebc40d4ddf3787f',
  ...
  USERS: ['ogJ-46BHgcSqHywLOU3iXtnG4x1E']
    {
      ...
      id: 'wxid_aoojoyfOr9qm22',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '7ZGGbrrJDpAGT6Jz3GhdwQlQDKnaKtDoWGsJthgy7Sw',
      // 所在省份
      province: '河北',
      // 所在城市
      city: '邢台',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '小徐同学', year: '2003', date: '02-24',
        },
        {
          type: '节日', name: '在一起纪念日', year: '2021', date: '12-23',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '小马同学', year: '2002', date: '01-15',
        },
        {
